...
def hubert_base_robust_mgr(refresh=False, *args, **kwargs):
    ...
    For more information, please refer to the paper, https://arxiv.org/abs/2203.16104.
        refresh (bool): whether to download ckpt/config again if existed
    """
...
def hubert_base_robust_mgwham_rbp(refresh=False, *args, **kwargs):
    """
    The Base model, continually trained with Libri 960 hr with distortions.
    Distortions include Musan, Gaussian, WHAM, reverb, bandrej, pitch shift.
        refresh (bool): whether to download ckpt/config again if existed
    """
