...
class WaveDataset(Dataset):
    ...
    def _sample(self, x):
        ...
        if len(x_teacher) < self.sample_length and len(x_student) < self.sample_length:
            return x_teacher, x_student
        idx = random.randint(0, len(x_teacher) - self.sample_length)
        return x_teacher[idx : idx + self.sample_length], x_student[idx : idx + self.sample_length]
